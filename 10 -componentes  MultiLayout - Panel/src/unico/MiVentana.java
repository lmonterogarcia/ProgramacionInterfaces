...
public class MiVentana extends java.awt.Frame {
	...
	private void crearComponente() {
		...
		Panel panOperacionesSouth = new Panel();
		panOperacionesSouth.setLayout(new FlowLayout());
		
		Panel panOperacionesCenter = new Panel();
		panOperacionesCenter.setLayout(new GridLayout(2,3));

		//Agregar componentes al PanelSouth
		panOperacionesSouth.add(btn1);
		panOperacionesSouth.add(btn2);
		
		
		//Agregar componentes al PanelCenter
		panOperacionesCenter.add(btn3);
		panOperacionesCenter.add(btn4);
		panOperacionesCenter.add(btn5);
		panOperacionesCenter.add(btn6);
		
		//Agregar componentes al Frame
		add(panOperacionesSouth, BorderLayout.SOUTH);
		add(panOperacionesCenter, BorderLayout.CENTER);
	}
