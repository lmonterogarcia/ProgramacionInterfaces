...
public class FrmPrincipal extends JFrame {
	...
	public static JTable tblResultadoConsulta;
	private JPanel panel;
	private JButton btnEjecutar;
	public static JTextArea txtConsulta;
...
//		setResizable(false);
	...
	private void agregarComponentes() {
		...
		tblResultadoConsulta = new JTable();
		tblResultadoConsulta.setFont(new Font("Courier", Font.PLAIN, 13));
		
		scrollPane_1 = new JScrollPane(tblResultadoConsulta);
	...
	private void agregarEventos() {
		...
		btnEjecutar.addActionListener(e -> ctrl.CtrlFrmPrincipal.ejecutar());
