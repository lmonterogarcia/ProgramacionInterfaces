...
public class LogConsultas {
	...
	public static DefaultTableModel consulta(String sConsulta) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		ResultSet resultado;
		...
		DefaultTableModel tableModel = new DefaultTableModel() {public boolean isCellEditable(int row, int column) {return false;}};
