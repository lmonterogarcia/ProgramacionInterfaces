...
public class LogConsultas {
	...
	public static DefaultTableModel consultaParaTablas(String sConsulta)
...
//				System.out.println("Salario: " + resultado.getInt("SAL"));
	...
	public static String[] consultaDetalle(String sEmpNo)
			throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		String[] aEmpleado = new String[6];
		
		String sConsulta = "SELECT E1.ENAME, E1.JOB, E1.SAL, E1.COMM, E1.HIREDATE, (SELECT E2.ENAME FROM EMP E2 WHERE E2.EMPNO = E1.MGR)  FROM EMP E1 WHERE E1.EMPNO = " + sEmpNo;
		...
		for (int i = 0; i < aEmpleado.length; i++) {
			aEmpleado[i] = resultado.getString(i + 1);
		}
