...
public class MiVentana extends java.awt.Frame {
	...
	private void crearComponente() {
		...
		//		opcReembolso.setLabel("opcReembolso");
		//		opcReembolso.setState(true);
		//		Checkbox opcReembolso = new Checkbox("Reembolso", true);
		//		opcReembolso.setBounds(140,50,100,20);

		Label lblFormar = new Label("Formas de Pago:");
		lblFormar.setAlignment(Label.CENTER);
		
		CheckboxGroup grpFormasPago = new CheckboxGroup();
		Checkbox opcEfectivo = new Checkbox("Efectivo", true, grpFormasPago);
		Checkbox opcTarjeta= new Checkbox("Tarejta", false, grpFormasPago);
		Checkbox opcBizzun = new Checkbox("Bizzum", false, grpFormasPago);
